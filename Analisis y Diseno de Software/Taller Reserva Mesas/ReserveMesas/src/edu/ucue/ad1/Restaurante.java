...
public class Restaurante {
    ...
    List<Mesa> listarMesasLibres(String fecha, String hora) {
        ...
        for (Ubicacion ubicacion : ubicaciones) {
            ...
            for (Mesa mesa : ubicacion.getMesas()) {
                    agregarMesaLibre(mesasLibres, mesa, fecha, hora);
            }
    ...
    private void agregarMesaLibre(List<Mesa> mesasLibres, Mesa mesa, String fecha, String hora)
    {
        if (mesa.isMesaLibre(fecha, hora))
            mesasLibres.add(mesa);
    }

    void addUbicacion(String nombre) {
        Ubicacion ubicacion = new Ubicacion(nombre, this);
