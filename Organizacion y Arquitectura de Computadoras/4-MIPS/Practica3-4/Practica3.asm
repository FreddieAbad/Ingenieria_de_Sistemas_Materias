...
main:
	...
	li $a1,9			#Limita el tamaño del buffer
	syscall
	...
	mul $t2,$t1,$t0			#Multiplicar y guardar en temporal $t2 la multiplicación de $t0 * $t1
	lw $a0,array($t2)		#Cargar en el registro $a0 lo que contenga el array en la posición %t2
