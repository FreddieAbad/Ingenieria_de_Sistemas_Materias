...
class FirestoreClient {
     ...
     */
    start(databaseInfo, offlineComponentProvider, onlineComponentProvider) {
        ...
        this.credentials.setChangeListener(user => {
            if (!initialized) {
                ...
                return this.initializeComponents(offlineComponentProvider, onlineComponentProvider, user, persistenceResult).then(this.initializationDone.resolve, this.initializationDone.reject);
            }
            else {
     ...
     *     succeeded.
     */
    async initializeComponents(offlineComponentProvider, onlineComponentProvider, user, persistenceResult) {
        try {
            ...
            console.warn('Error enabling offline persistence. Falling back to' +
                ...
                error);
            return this.initializeComponents(new MemoryOfflineComponentProvider(), new OnlineComponentProvider(), user, persistenceResult);
        }
    }
    /**
...
class UserDataWriter {
    constructor(databaseId, serverTimestampBehavior, referenceFactory, bytesFactory) {
        this.databaseId = databaseId;
...
class IndexedDbPersistenceProvider {
    enableIndexedDbPersistence(firestore, forceOwnership) {
        ...
        const offlineComponentProvider = new IndexedDbOfflineComponentProvider(onlineComponentProvider, firestore._getSettings().cacheSizeBytes, forceOwnership);
        return firestore._configureClient(offlineComponentProvider, onlineComponentProvider);
    }
    enableMultiTabIndexedDbPersistence(firestore) {
        const onlineComponentProvider = new OnlineComponentProvider();
        const offlineComponentProvider = new MultiTabOfflineComponentProvider(onlineComponentProvider, firestore._getSettings().cacheSizeBytes);
        return firestore._configureClient(offlineComponentProvider, onlineComponentProvider);
    }
    clearIndexedDbPersistence(firestore) {
        const deferred = new Deferred();
...
class Firestore {
    ...
    constructor(databaseIdOrApp, authProvider, _persistenceProvider = new MemoryPersistenceProvider()) {
    ...
    // https://github.com/firebase/firebase-js-sdk/pull/3901.
    _configureClient(offlineComponentProvider, onlineComponentProvider) {
...
class DocumentSnapshot {
    ...
    data(options = {}) {
        if (!this._document) {
            ...
            if (this._converter) {
                ...
                const userDataWriter = new UserDataWriter(this._firestore._databaseId, options.serverTimestamps || 'none', key => new DocumentReference(key, this._firestore, /* converter= */ null), bytes => new Blob(bytes));
    ...
    get(fieldPath, options = {}) {
        if (this._document) {
            ...
            if (value !== null) {
                const userDataWriter = new UserDataWriter(this._firestore._databaseId, options.serverTimestamps || 'none', key => new DocumentReference(key, this._firestore, this._converter), bytes => new Blob(bytes));
...
class Query {
    ...
    where(field, opStr, value) {
        ...
        const filter = newQueryFilter(this._query, 'Query.where', this.firestore._dataReader, this.firestore._databaseId, fieldPath, opStr, value);
