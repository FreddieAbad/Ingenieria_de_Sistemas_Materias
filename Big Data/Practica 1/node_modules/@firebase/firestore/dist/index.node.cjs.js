...
var IndexedDbRemoteDocumentCacheImpl = /** @class */ (function () {
     ...
     */
    IndexedDbRemoteDocumentCacheImpl.prototype.maybeDecodeDocument = function (dbRemoteDoc) {
        if (dbRemoteDoc) {
...
var IndexedDbRemoteDocumentChangeBuffer = /** @class */ (function (_super) {
    ...
    IndexedDbRemoteDocumentChangeBuffer.prototype.getAllFromCache = function (transaction, documentKeys) {
        ...
        return this.documentCache
            ...
            .next(function (_d) {
            var maybeDocuments = _d.maybeDocuments, sizeMap = _d.sizeMap;
...
function eventManagerListen(eventManager, listener) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var eventManagerImpl, query, firstListen, queryInfo, _d, e_8, firestoreError, raisedEvent, raisedEvent_1;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
...
function syncEngineWrite(syncEngine, batch, userCallback) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var syncEngineImpl, result, e_9, error;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 5:
                    e_9 = _d.sent();
                    error = wrapInUserErrorIfRecoverable(e_9, "Failed to persist write");
...
function synchronizeQueryViewsAndRaiseSnapshots(syncEngine, targets, transitionToPrimary) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var syncEngineImpl, activeQueries, newViewSnapshots, _i, targets_1, targetId, targetData, queries, _d, queries_2, query, queryView, viewChange, target;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    syncEngineImpl = debugCast(syncEngine);
...
var IndexedDbOfflineComponentProvider = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, ensureWriteCallbacks(this.onlineComponentProvider.syncEngine)];
                    case 4:
                        // Enqueue writes from a previous session
                        _d.sent();
    ...
    IndexedDbOfflineComponentProvider.prototype.createPersistence = function (cfg) {
        ...
        return new IndexedDbPersistence(this.synchronizeTabs, persistenceKey, cfg.clientId, lruParams, cfg.asyncQueue, getWindow(), getDocument(), serializer, this.sharedClientState, !!this.forceOwnership);
    };
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        if (!canFallbackFromIndexedDbError(error_5)) {
                            throw error_5;
                        }
...
var IndexedDbPersistenceProvider = /** @class */ (function () {
    ...
    IndexedDbPersistenceProvider.prototype.enableIndexedDbPersistence = function (firestore, forceOwnership) {
        ...
        var offlineComponentProvider = new IndexedDbOfflineComponentProvider(onlineComponentProvider, firestore._getSettings().cacheSizeBytes, forceOwnership);
        return firestore._configureClient(offlineComponentProvider, onlineComponentProvider);
    };
    IndexedDbPersistenceProvider.prototype.enableMultiTabIndexedDbPersistence = function (firestore) {
        var onlineComponentProvider = new OnlineComponentProvider();
        var offlineComponentProvider = new MultiTabOfflineComponentProvider(onlineComponentProvider, firestore._getSettings().cacheSizeBytes);
        return firestore._configureClient(offlineComponentProvider, onlineComponentProvider);
    };
...
var Firestore = /** @class */ (function () {
    ...
    Firestore.prototype.clearPersistence = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_d) {
                ...
                return [2 /*return*/, this._persistenceProvider.clearIndexedDbPersistence(this)];
            });
        });
    };
    ...
    Firestore.prototype.ensureClientConfigured = function () {
        if (!this._firestoreClient) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-floating-promises
            this._configureClient(new MemoryOfflineComponentProvider(), new OnlineComponentProvider());
        }
    ...
    // https://github.com/firebase/firebase-js-sdk/pull/3901.
    Firestore.prototype._configureClient = function (offlineComponentProvider, onlineComponentProvider) {
        var databaseInfo = this.makeDatabaseInfo();
        this._firestoreClient = new FirestoreClient(this._credentials, this._queue);
        return this._firestoreClient.start(databaseInfo, offlineComponentProvider, onlineComponentProvider);
    };
...
var DocumentSnapshot = /** @class */ (function () {
    ...
    DocumentSnapshot.prototype.data = function (options) {
        ...
        if (!this._document) {
            ...
            if (this._converter) {
                ...
                var userDataWriter = new UserDataWriter(this._firestore._databaseId, options.serverTimestamps || 'none', function (key) { return new DocumentReference(key, _this._firestore, /* converter= */ null); }, function (bytes) { return new Blob(bytes); });
    ...
    DocumentSnapshot.prototype.get = function (fieldPath, options) {
        ...
        if (this._document) {
            ...
            if (value !== null) {
                var userDataWriter = new UserDataWriter(this._firestore._databaseId, options.serverTimestamps || 'none', function (key) { return new DocumentReference(key, _this._firestore, _this._converter); }, function (bytes) { return new Blob(bytes); });
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.where = function (field, opStr, value) {
        ...
        var filter = newQueryFilter(this._query, 'Query.where', this.firestore._dataReader, this.firestore._databaseId, fieldPath, opStr, value);
